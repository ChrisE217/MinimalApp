        ...
        webBuilder.Configure(_ => 
        {
            ...
            { 
                endpoints.MapGet("/", async context =>
                {
                    ...
                    var responseString = $"Add Item to In Memory DB test deploy</br><form action=\"/additem\" method=\"post\"><label for=\"name\">Name: </label></br><input type=\"text\" id=\"name\"/ name=\"name\" placeholder=\"Enter name\" maxlength=\"15\"><button type=\"submit\">Add</button></form></br><style>table, th, td{{border: 1px solid black}}</style><table><tr><th>Id</th><th>Name</th>";
